...
import { apply, bookingList, reject, unbind } from "@/interfaces/index";
import dayjs from "dayjs";

import { MeetingRoomSearchResult } from "./meeting-roomManagement";
import { UserSearchResult } from "./user-management";
...
export function ReservationManagement() {
  ...
  const columns: ColumnsType<BookingSearchResult> = [
    ...
    },
    {
      ...
      dataIndex: "user",
      render(_, record) {
        return record.user?.username || 'N/A';
      },
    },
    {
      title: "开始时间",
